...
We will be accessing the Concourse portal though an AWS load balancer, so will need some keys.
...
{
    "ServerCertificate": {
        "CertificateBody": "-----BEGIN CERTIFICATE-----\nMIIDEjCCAfoCCQDFYXvpOvGahjANBgkqhkiGfCYgMHLP2Nkg==\n-----END CERTIFICATE-----",
        "ServerCertificateMetadata": {
            "ServerCertificateId": "AWEDJNGHRUFKDN232342346",
            "ServerCertificateName": "concourse-server-certificate",
            "Expiration": "2018-07-10T17:31:00Z",
            "Path": "/",
            "Arn": "arn:aws:iam::27046474656:server-certificate/concourse-server-certificate",
            "UploadDate": "2017-07-10T17:45:51Z"
        }
    }
}
